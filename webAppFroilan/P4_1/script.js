...
function sortGrades(){
  ...
  grades.forEach(function (item){document.getElementById("list").innerHTML += item + "<br>";})
}

function displayGrades(){
	document.getElementById("output").innerHTML = "";
	grades.forEach(function (item){document.getElementById("output").innerHTML += item + "<br>";})
}

function averageGrades(){
let average;
let sum = 0;
grades.forEach(function (item){sum += item});
